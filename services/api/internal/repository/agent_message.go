...
func (r *AgentMessageRepository) GetByStepID(stepID string) ([]model.AgentMessage, error) {
	query := `SELECT id, run_id, step_id, profile_id, role, content, metadata, created_at FROM agent_messages WHERE step_id = $1 ORDER BY created_at ASC`
