...
import { getAgentProfiles, getAgentTeams, AgentProfile, AgentTeam } from '@/lib/api'
import { AgentProfileList } from '@/components/Agents/AgentProfileList'
import { AgentTeamList } from '@/components/Agents/AgentTeamList'
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage agent profiles and teams
          </p>
        </div>
        <div className="flex gap-3">
          <Link href="/agents/profiles/new">
      ...
      {!isApiDown && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <AgentProfileList profiles={profiles} />
          <AgentTeamList teams={teams} />
        </div>
      )}
    </div>
  )
